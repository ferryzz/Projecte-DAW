    ...
    <div class="container">
        <div class="row">
         <div class="col-sm-12">
			...
			<p> 
			Esta forma de pago es inmediata y totalmente segura. Se aceptan tarjetas de débito, de crédito y por supuesto cuentas Paypal. En caso de que el pedido sea cancelado por el cliente se el administrador se pondra en contacto.
			</p>
</div>
</div>
</div>
