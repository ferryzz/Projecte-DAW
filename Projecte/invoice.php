...
function addNumTVA($tva)
{
    ...
    $this->Cell(40, 4, "ID de Factura", '', '', "C");
    $this->SetFont( "Arial", "", 10);
...
function addCadreEurosFrancs($total,$iva_total,$total_amb_iva)
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $this->h - 40;
    ...
    $this->SetFont( "Arial", "B", 8);
    $this->SetXY( $r1+22, $y1 );
    $this->Cell(39,4, "TOTAL (EN EUROS)", 0, 0, "C");
    $this->SetFont( "Arial", "", 8);
    $this->SetXY( $r1+42, $y1 );
    $this->SetFont( "Arial", "B", 6);
    $this->SetXY( $r1, $y1+5 );
    
    $this->Cell(20,4, "TOTAL SIN IVA", 0, 0, "C");
    $this->Cell( 39,4, round($total, 2), 0, 0, 'C');
    $this->SetXY( $r1, $y1+10 );

    $this->Cell(20,4, "IVA (21%)", 0, 0, "C");
    $this->Cell( 39,4, round($iva_total, 2), 0, 0, 'C');
    $this->SetXY( $r1, $y1+15 );
    $this->Cell(20,4, "TOTAL A PAGAR", 0, 0, "C");
    $this->Cell( 39,4, round($total_amb_iva, 2), 0, 0, 'C');
}
...
function addTVAs( $params, $tab_tva, $invoice )
{
    ...
    $this->SetFont( "Arial", "", 8);
    $this->SetXY( $re, $y1+5 );
    //$this->Cell( 17,4, sprintf("%0.2F", 2), '', '', 'R');
    $this->SetXY( $re, $y1+10 );
    //$this->Cell( 17,4, sprintf("%0.2F", 2), '', '', 'R');
    $this->SetXY( $re, $y1+14.8 );
    //$this->Cell( 17,4, sprintf("%0.2F", 3 - 2), '', '', 'R');
    $this->SetXY( $rf, $y1+5 );
    //$this->Cell( 17,4, sprintf("%0.2F", 2 * EURO_VAL), '', '', 'R');
    $this->SetXY( $rf, $y1+10 );
    //$this->Cell( 17,4, sprintf("%0.2F", 2 * EURO_VAL), '', '', 'R');
    $this->SetXY( $rf, $y1+14.8 );
    //$this->Cell( 17,4, sprintf("%0.2F", (3 - 2) * EURO_VAL), '', '', 'R');
}
