...
<head>
	...
	<title>IMMOBESPA</title>
  </head>
<body>
    <div class="jumbotron">
		  <div class="container text-center">
			<h1 class="textos">Online Store</h1>    
		  </div>
		</div>
		 ...
		 <nav class="navbar navbar-inverse">
		  <div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="http://localhost/projecte/index.php/welcome/cesta_resumen"><span class="glyphicon glyphicon-shopping-cart"></span> Cistella</a></li>
			</ul>		
